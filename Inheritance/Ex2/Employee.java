...
public class Employee extends Person{
	...
	public String toString() {
		return "Employee [salary=" + salary + ", year_employee_started=" + year_employee_started
				+ ", national_insurance_number=" + national_insurance_number + ", member=" + member + ", getSalary()="
				+ getSalary() + ", getYear_employee_started()=" + getYear_employee_started()
				+ ", getNational_insurance_number()=" + getNational_insurance_number() + ", getMember()=" + getMember()
